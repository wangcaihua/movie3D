...
from myquant.utils import todayDate, getJsonPath
from myquant.dataStruct import VtSubscribeReq, VtLogData
from myquant.app.ctaStrategy.ctaTemplate import BarGenerator
...
class DrEngine(object):
    ...
    def registerEvent(self):
        """注册事件监听"""
        self.eventEngine.register(Event.TICK, self.procecssTickEvent)
    ...
    def writeDrLog(self, content):
        ...
        event = Event(type_=Event.DATARECORDER_LOG)
