...
from .text import *
from myquant.framework import Event
from myquant.mainUI.uiQt import QtWidgets, QtCore
...
class DrEngineManager(QtWidgets.QWidget):
    ...
    def initUi(self):
        """初始化界面"""
        self.setWindowTitle(DATA_RECORDER)

        # 记录合约配置监控
        tickLabel = QtWidgets.QLabel(TICK_RECORD)
        ...
        self.tickTable.setHorizontalHeaderLabels([CONTRACT_SYMBOL, GATEWAY])

        barLabel = QtWidgets.QLabel(BAR_RECORD)
        ...
        self.barTable.setHorizontalHeaderLabels([CONTRACT_SYMBOL, GATEWAY])

        activeLabel = QtWidgets.QLabel(DOMINANT_CONTRACT)
        ...
        self.activeTable.setHorizontalHeaderLabels([DOMINANT_SYMBOL, CONTRACT_SYMBOL])
    ...
    def registerEvent(self):
        ...
        self.eventEngine.register(Event.DATARECORDER_LOG, self.signal.emit)
