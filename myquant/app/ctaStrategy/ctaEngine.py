...
from myquant.dataStruct import VtTickData, VtBarData
from myquant.dataStruct import VtSubscribeReq, VtOrderReq, VtCancelOrderReq, VtLogData
from ...utils import todayDate, getJsonPath
...
class CtaEngine(object):
    ...
    STATUS_FINISHED = {STATUS_REJECTED, STATUS_CANCELLED, STATUS_ALLTRADED}
    ...
    def __init__(self, mainEngine, eventEngine):
        ...
        # 注册日式事件类型
        self.mainEngine.registerLogEvent(Event.CTA_LOG)
    ...
    def writeCtaLog(self, content):
        ...
        event = Event(type_=Event.CTA_LOG)
    ...
    def putStrategyEvent(self, name):
        ...
        event = Event(Event.CTA_STRATEGY + name)
        event.dict_['data'] = d
        self.eventEngine.put(event)

        d2 = {k: str(v) for k, v in d.items()}
        d2['name'] = name
        event2 = Event(Event.CTA_STRATEGY)
