...
from myquant.mainUI.uiBasicWidget import QtCore, QtWidgets
...
class CtaStrategyManager(QtWidgets.QGroupBox):
    ...
    def initUi(self):
        ...
        buttonInit = QtWidgets.QPushButton(INIT)
    ...
    def registerEvent(self):
        ...
        self.eventEngine.register(Event.CTA_STRATEGY + self.name, self.signal.emit)
...
class CtaEngineManager(QtWidgets.QWidget):
    ...
    def initUi(self):
        ...
        # 按钮
        loadButton = QtWidgets.QPushButton(LOAD_STRATEGY)
        initAllButton = QtWidgets.QPushButton(INIT_ALL)
        startAllButton = QtWidgets.QPushButton(START_ALL)
        stopAllButton = QtWidgets.QPushButton(STOP_ALL)
    ...
    def registerEvent(self):
        ...
        self.eventEngine.register(Event.CTA_LOG, self.signal.emit)
