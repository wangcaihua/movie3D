...
from myquant.mainUI.uiBasicWidget import (BasicMonitor, BasicCell, PnlCell,
                                          AskCell, BidCell, BASIC_FONT)

from myquant.app.spreadTrading.stAlgo import StAlgoTemplate
...
class StTickMonitor(BasicMonitor):
    ...
    def __init__(self, mainEngine, eventEngine, parent=None):
        ...
        self.setEventType(Event.SPREADTRADING_TICK)
...
class StPosMonitor(BasicMonitor):
    ...
    def __init__(self, mainEngine, eventEngine, parent=None):
        ...
        self.setDataKey('name')
        self.setEventType(Event.SPREADTRADING_POS)
        self.setFont(BASIC_FONT)
...
class StLogMonitor(QtWidgets.QTextEdit):
    ...
    def registerEvent(self):
        ...
        self.eventEngine.register(Event.SPREADTRADING_LOG, self.signal.emit)
...
class StAlgoLogMonitor(BasicMonitor):
    ...
    def __init__(self, mainEngine, eventEngine, parent=None):
        ...
        self.setEventType(Event.SPREADTRADING_ALGOLOG)
        self.setFont(BASIC_FONT)
